    ...
    <section>
        <div className="flex flex-wrap justify-center align-center gap-24">
            ...
            <div className="flex flex-col items-center justify-center gap-8 md:w-1/2 text-center">
                ...
                <p className="text-white">Si te ofrecen un asiento en un cohete a punto de despegar, no preguntes qué sitio es. Simplemente, ¡súbete!</p>
                <p className="text-primary">Sheryl Sanberg</p>
            </div>
        </div>
    </section>
);
